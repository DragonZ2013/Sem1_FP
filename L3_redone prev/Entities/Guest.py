class Gaste:
    ...
    def set_nachname(self, a):
        self.__nachname = a

    @vorname.setter#setter vorname
    def set_vorname(self, b):
        self.__vorname = b
    ...
    '''def __str__(self):#guest string conversion
        return "Nachname: %s Vorname: %s Reserveriung:%s " % (self.__nachname, self.__vorname, self.__reserv)'''
