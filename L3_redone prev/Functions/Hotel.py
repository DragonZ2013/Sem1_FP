...
class Hotel:
    ...
    @property
    def reservs(self): return self.__reservs

    @property
    def index_reserv(self): return self.__index_reserv

    @index_reserv.setter
    def index_reserv(self,val): self.__index_reserv=val
