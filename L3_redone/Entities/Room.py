class Room:
    ...
    def __str__(self):#Room string conversion
        if self.__sea_view == 1:
            return "Nr:"+str(self.__nr)+" MaxGuests:"+str(self.__maxguest)+" Preis:"+str(self.__price)+" Farbe:"+str(self.__color)+" Meerblick: Ya"
        else:
            return "Nr:"+str(self.__nr)+" MaxGuests:"+str(self.__maxguest)+" Preis:"+str(self.__price)+" Farbe:"+str(self.__color)+" Meerblick: Nein"