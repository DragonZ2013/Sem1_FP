...
class GUI:
    ...
    def populate_mainmenu(self):
        ...
        btn4 = Button(self.__mainmenu, text='Exit', command=self.close_all)
        btn4.grid(column=3, row=0)

        btn5 = Button(self.__mainmenu, text='Save', command= lambda: self.saveToFile(self.__controller, self.pick_out_file()))
        btn5.grid(column=3, row=5)

        btn6 = Button(self.__mainmenu, text='Load', command= lambda: self.loadFromFile(self.__controller, self.pick_in_file()))
        btn6.grid(column=1, row=5)

        btn7 = Button(self.__mainmenu, text='Add', command= lambda: self.addFromFile(self.__controller, self.pick_in_file()))
